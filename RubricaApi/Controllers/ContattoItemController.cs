...
namespace RubricaApi.Controllers
{
    ...
    [ApiController]
    public class ContattoItemController : ControllerBase
    {
        private readonly RubricaContext _context;

        public ContattoItemController(RubricaContext context)
        {
            _context = context;
        }

        // GET: api/ContattoItem
        [HttpGet]
